...
Before connect a LAN cable from PC to the Router, You must decrease Ethernet link speed to 10Mb/s, because dont knows upload correct the firmware to the Chip (###error, try again!!!###).

...
=== Know Bug === Before connect a LAN cable from PC to the Router, You must change Ethernet link speed to 10Mb/s, because dont knows upload correct the firmware to Chip (###error, try again!!!###).
